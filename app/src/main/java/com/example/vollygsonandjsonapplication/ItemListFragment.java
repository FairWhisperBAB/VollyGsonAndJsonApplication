...
import com.example.vollygsonandjsonapplication.databinding.FragmentItemListBinding;
import com.example.vollygsonandjsonapplication.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    private void setupRecyclerView(
        ...
        Parse.testAllThatJazz(getActivity());
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                holder.itemView.setOnContextClickListener(v -> {
                    MODEL item =
                            (MODEL) holder.itemView.getTag();
                    Toast.makeText(
                            holder.itemView.getContext(),
                            "Context click of item " + item.gameCompanyName,
                            Toast.LENGTH_LONG
                    ).show();
                    return true;
                });
            ...
            holder.itemView.setOnLongClickListener(v -> {
                ...
                ClipData dragData = new ClipData(
                        ((MODEL) v.getTag()).gameCompanyYearFounded,
